...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["entrypoint_admin_id"], ["entrypoint.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["entrypoint_id"], ["entrypoint.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.Column("description", sa.String(), nullable=True),
        sa.ForeignKeyConstraint(
            ["server_host_id"], ["server_host.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column("description", sa.String(), nullable=True),
        sa.ForeignKeyConstraint(
            ["server_port_id"], ["server_port.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
