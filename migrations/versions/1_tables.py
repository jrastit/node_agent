...
Revision ID: 1
Revises: 
Create Date: 2026-03-06 16:25:28.703151
...
def upgrade() -> None:
    ...
    op.create_table('server_port',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('server_host_id', sa.Integer(), nullable=False),
    sa.Column('time_create', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('time_updated', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('port', sa.String(), nullable=True),
    sa.Column('description', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['server_host_id'], ['server_host.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('description', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['server_port_id'], ['server_port.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
